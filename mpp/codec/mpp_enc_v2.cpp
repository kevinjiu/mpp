...
RK_U32 _mpp_enc_debug = 0;  // KevinJ changed mpp_enc_debug to _mpp_enc_debug to prevent conflicting with gstreamer_rockchip
...
MPP_RET mpp_enc_init_v2(MppEnc *enc, MppEncInitCfg *cfg)
{
    ...
    mpp_env_get_u32("mpp_enc_debug", &_mpp_enc_debug, 0);
